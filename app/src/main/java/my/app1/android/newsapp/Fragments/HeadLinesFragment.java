...
public class HeadLinesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private final static String url1 = "https://newsapi.org/v2/top-headlines?country=us&apiKey=26f4fa133fef4b0bad0541e0cb0afe02";
    private final static String url2 = "https://newsapi.org/v2/everything?sources=msnbc&apiKey=8292501988f741178dea96d87d5c19cc";
